        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 text-center">
              ...
              <h5>Directional Gaze Assistance</h5>
              <p>
        ...
        <div className="container text-center">
          ...
          <div className="row">
            <div className="col-md-4 mt-3">
              <h5 className="target-audience-paragraph">Professional Speakers</h5>
              <p className="target-audience-paragraph">
                <strong>SPIKE</strong> your engagement and seamlessly integrate our tools into
                your workflow.
              </p>
            </div>
            <div className="col-md-4 mt-3">
              <h5 className="target-audience-paragraph">Business Professionals</h5>
              <p className="target-audience-paragraph">
                <strong>TUBROCHARGE</strong> your professional image and leave a
                lasting legacy.
              </p>
            </div>
            <div className="col-md-4 mt-3">
              <h5 className="target-audience-paragraph">Educators</h5>
              <p className="target-audience-paragraph">
                <strong>AMELIORATE</strong> your teaching with AI-suggested body
                language and tone suggestions.
              </p>
            </div>
            <div className="col-md-4 mt-3">
              <h5 className="target-audience-paragraph">Enthusiasts</h5>
              <p className="target-audience-paragraph">
                <strong>GAIN</strong> quick, accessible learning and a powerful, personalized
                mentor!
              </p>
            </div>
            <div className="col-md-4 mt-3">
              <h5 className="target-audience-paragraph">Content Creator</h5>
              <p className="target-audience-paragraph"><strong>INCREASE</strong> natural delivery and on-camera presence</p>
            </div>
            <div className="col-md-4 mt-3">
              <h5 className="target-audience-paragraph">
                <strong>YOU</strong>
              </h5>
              <p className="target-audience-paragraph">
                <strong>Yes, you!</strong> Whether you want to improve your public speaking planning or
                enhance your on-camera presence, Omniwave Nexus is here to serve
